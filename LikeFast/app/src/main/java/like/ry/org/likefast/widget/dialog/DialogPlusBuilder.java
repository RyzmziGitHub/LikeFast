...
public class DialogPlusBuilder {
  ...
  public View getFooterView() {
    return AppUtil.getView(context, footerViewResourceId, footerView);
  }

  public View getHeaderView() {
    return AppUtil.getView(context, headerViewResourceId, headerView);
  }
  ...
  public Animation getInAnimation() {
    int res = (inAnimation == INVALID) ? AppUtil.getAnimationResource(this.gravity, true) : inAnimation;
    return AnimationUtils.loadAnimation(context, res);
  }

  public Animation getOutAnimation() {
    int res = (outAnimation == INVALID) ? AppUtil.getAnimationResource(this.gravity, false) : outAnimation;
    return AnimationUtils.loadAnimation(context, res);
  }
  ...
  public int getDefaultContentHeight() {
    ...
    int displayHeight = display.getHeight() - AppUtil.getStatusBarHeight(activity);
